            ...
            if (field.isAnnotationPresent(SignatureField.class))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            map.put(StringUtils.isNotBlank(sgf.customName()) ? sgf.customName() : field.getName(), StringUtils.isNotEmpty(sgf.customValue()) ? sgf.customValue() : toString(field.get(object)));
                        }
                    }
                }
                catch (Exception e)
            ...
            if (field.isAnnotationPresent(SignatureField.class))
            {
                ...
                try
                {
                    ...
                    else
                    {
                        if (StringUtils.isNotEmpty(sgf.customValue()) || !Objects.isNull(field.get(object)))
                        {
                            set.add(new OrderNode(sgf.order(), StringUtils.isNotBlank(sgf.customName()) ? sgf.customName() : field.getName(), StringUtils.isNotEmpty(sgf.customValue()) ? sgf.customValue() : toString(field.get(object))));
                        }
                    }
                }
                catch (Exception e)
